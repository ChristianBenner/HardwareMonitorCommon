...
public class PageCreateMessageTest {
    ...
    public void testWriteRead() {
        ...
        Assert.assertEquals(out.getPageColourR(), in.getPageColourR());
        Assert.assertEquals(out.getPageColourG(), in.getPageColourG());
        Assert.assertEquals(out.getPageColourB(), in.getPageColourB());
        ...
        Assert.assertEquals(out.getPageRows(), in.getPageRows());
        Assert.assertEquals(out.getPageColumns(), in.getPageColumns());
        Assert.assertEquals(out.getNextPageId(), in.getNextPageId());
        Assert.assertEquals(out.getPageTransitionType(), in.getPageTransitionType());
        Assert.assertEquals(out.getPageTransitionTime(), in.getPageTransitionTime());
        Assert.assertEquals(out.getPageDurationMs(), in.getPageDurationMs());
